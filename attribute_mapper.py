from lib.dataset_encoders import *
from collections import defaultdict 


def Variant1Mapper(traces):
...
def generalMapper(traces, categorical_vars, continuous_vars):
    categorical_attributes = categorical_vars
    continuous_attributes = continuous_vars
